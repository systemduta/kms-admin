...
const actions = {
  ...
  async show ({commit}, id) {
    try {
      const { data } = await axios.get(`api/web/cros_lamp/${id}`)
  ...
  async destroy (store, id) {
    try {
      const { data } = await axios.delete(`api/web/cros_lamp/${id}`)
      return Promise.resolve(data)
    } catch (error) {
      return Promise.reject(error.response)
    }
  ...
  async store ({commit}, payload) {
    try {
      const { data } = await axios.post('api/web/cros_lamp',
        payload,
        {
          headers: {
  ...
  async update (store, payload) {
    ...
    try {
      const { data } = await axios.post(`api/web/cros_lamp/${id}`, payload)
      return Promise.resolve(data)
    } catch (error) {
      return Promise.reject(error.response)
    }
  ...
  async status (store, id) {
    try {
      const { data } = await axios.get(`api/web/lamcross_status/${id}`)
      return Promise.resolve(data)
    } catch (error) {
      return Promise.reject(error.response)
    }
