<template>
  <div class="vx-row">
    <div class="w-full vx-col mb-base">
      <vx-card title="All Crossfunction" class="rounded-card">
        <vs-table pagination search :data="data" class="mb-base">
          <template slot="header">
            ...
            <vs-button @click="popupActivo=true">Tambah Crossfunction</vs-button>
            <vs-popup id="create-crossfunction" v-model="popUp" class="holamundo"  title="Input Data Crossfunction" :active.sync="popupActivo">
              <vx-card>
