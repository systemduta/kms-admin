  ...
  <div class="vx-row">
    <div class="w-full vx-col mb-base">
      <vs-button
        ...
        >Kembali</vs-button
      >
      <vx-card :title="'Dimensi PAS: ' + name3p">
        <vs-table
          pagination
          max-items="15"
          search
              ...
              <vs-td>
                <div class="flex">
                  <vs-button
                    ...
                    icon="icon-eye"
                    size="small"
                    @click="log(id3p, tr.id, idCompany)"
                  >
                  </vs-button>
                  &nbsp;
                  <vs-button
...
export default {
  ...
  methods: {
    ...
    log(id3p, iddimensi, idCompany) {
      console.log("id3p : " + id3p);
      console.log("iddimensi : " + iddimensi);
  ...
  mounted() {
    ...
    this.name3p = this.$route.params.name3p;
    this.id3p = this.$route.params.id;
