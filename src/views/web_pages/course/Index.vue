<template>
  <div class="vx-row">
    <div class="w-full vx-col mb-base">
      <vx-card title="All Division" class="rounded-card">
        <vs-table search :data="data" class="mb-base">
          <template slot="header">
            <!-- <vs-button :to="{name:'course-read'}">Create Course</vs-button> -->
            <vs-button @click="popupActivo=true">Tambah Course</vs-button>
            <vs-popup class="holamundo"  title="Input Data Course" :active.sync="popupActivo">
              <vx-card>
              ...
              <div class="mb-5 vx-row">
                <div class="w-full vx-col">
                  ...
                  <!--      memang comment      <input class="ml-2 mr-2" type="file" id="video" ref="file" @change="getBase64Video"/>-->
