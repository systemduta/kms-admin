        ...
        <vs-table search :data="data" class="mb-2">
          ...
          <template slot-scope="{ data }">
            <vs-tr :key="indextr" v-for="(tr, indextr) in data">
              ...
              <vs-td :data="tr.name_users">{{ tr.name_users }}</vs-td>
              <vs-td>
                <div class="flex">
                  <!-- <vs-button
                      class="mr-2"
...
export default {
  ...
  computed: {
    ...mapState({
      data: (state) => state.setadmin.rows,
    }),
  },
  methods: {
    ...mapActions({
      dispatchIndex: "setadmin/index",
      // dispatchDestroy: "setadmin/destroy",
    }),
    // format_date(value) {
    //   if (value) {
